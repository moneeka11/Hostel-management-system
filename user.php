      ...
      <div class="collapse navbar-collapse" id="collapsed">
        <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item">
             ...
             <center><a class="nav-link" href="profile.php?id=<?php echo $_SESSION['userid'] ?>"> profile</a></center>
           </li>
            <li class="nav-item">
         
             <center><a class="nav-link" href="feedback.php?id=<?php echo $_SESSION['userid'] ?>"">Feedback</a></center>
           </li>
           <!-- <li class="nav-item">
